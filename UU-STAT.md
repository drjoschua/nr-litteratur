...
They found that women were generally slightly less likely to have a disability than men.
...
The physical domain is most common (81%), followed by mental (33%) and communication domain (30%),
...
The World Health Organization (WHO) (2011) gives a general introduction in definitions and scope related to disability.

They descried the transition from an individua, medial model to a structural, social model, in which `people are viewed as being disabled by society rather than by their bodies`.
However, the authors follow the model adopted in the ICF, the `bio-psycho-social model`, in which functioning and disability is `a dynamic interaction between health conditions and contextual factors, both personal and environmental` including for example problems arising from a health condition.

```
[D]isability results from the interaction between persons with impairments and attitudinal and environmental barriers that hinder their full and effective participation in society on an equal basis with others.
```

Problems with human functioning can be categorized in three inter-connected areas:
1. Impairments: problems in body function or alterations in body structure.
2. Activity limitations: difficulties in executing activities.
3. Participation restrictions: problem with involvement in any area of life.

Health conditions (diseases, injuries and disorder) can influence impairments and vice versa.
...
* personal factors: can influence how much a person participates in society.
...
The World Health Organization (WHO) (2011) gives a general introduction in how to measure disability globally, and presents some estimates for the prevalence of disability.

Estimates differ widely. 
The WHO (2001) argues that the question design and reporting source can affect estimates.
For example, many developing countries only collect disability data through census and give only a narrow choice of impairments resulting in low disability prevalence rate.
Many developed countries record impairment, activity limitations and participation restriction resulting in higher disability prevalence.

They present prevalence estimates from 
* national surveys and censuses:
Surveys are difficult for comparisons because most developing countries collect data on a narrower set of impairments resulting in lower prevalence rates. 
Typically based on the Washington Group categorizations.
* the World Health Survey of 2002-2004:
a face-to-face household survey in a total of 70 countries of which 59 countries were used for estimation. 
...
Global ageing contributes to more disabilities.
...
These numbers are higher for high-income countries and lower for low- and middle-income countries.

They discuss the importance of environmental factors on disability including exposure to poor sanitation, malnutrition, lack of access to health care, changes caused by natural disasters of conflict situations.

They also point out that people with disabilities often have worse educational and labor market outcomes, and are more likely to be poorer than people without disabilities in both developing and developed countries.

They highlight costs related to disability.

Finally, they conclude that about 15% (WHS) / 19% (GBD) of the world population lives with disabilities.
Disability depends on many factors, including age, sex, stage of life, environmental risks, socioeconomic status, culture, and available resources.
...
* Developing appropriate tools and fill the research gaps
...
They define three purposes for the appropriate definition of disability used in a survey:
1. Monitoring the level of functioning in a population:
To improve understanding and evaluate interventions.
2. Designing service provision:
To design and implement programs requiring more extensive information.
3. Assessing the equalization of opportunity:
To assess the impact of having a disability on individuals and their families.
